    ...
    >
      ...
      <View style={{ marginBottom: 16 }}>
        <Text style={styles.progressText}>
          <Text style={{ color: "#C9A96E", fontWeight: "700" }}>
            {completedToday}
          </Text>
        ...
        <View style={styles.progressTrack}>
          <View
            style={[
              ...
              {
                width:
                  `${habits.length > 0 ? (completedToday / habits.length) * 100 : 0}%` as any,
              },
            ]}
          />
        </View>
